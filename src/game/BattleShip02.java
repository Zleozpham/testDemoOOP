...
public class BattleShip02 extends Tower
{

	public BattleShip02(Coordinate pos)
	{
		ImageLoader loader = ImageLoader.getLoader();
		this.tower = loader.getImage("resources/battleShip02.png");
		this.position = pos;
		this.anchorX = -50;
		this.anchorY = -50;
	}
	...
	public void interact(Game game, double deltaTime)
	{
		...
		{	
			...
			if(dist < 100)
			{	Gun02 gun02 = new Gun02(pos, enemyPos);
				game.effects.add(gun02);
				timeSinceLastFire = 0;
				return;
			}	
		} 
